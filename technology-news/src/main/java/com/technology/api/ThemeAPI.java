...
public class ThemeAPI {
	...
	@GetMapping("/oneTheme")
	public ThemeDTO getOneThemeById(@RequestParam("themeId") long id){
		return themeService.getOneThemeById(id);
	}
	...
	public ThemeDTO getThemeByName(@RequestParam("name") String name){
		return themeService.getThemeByName(name);
	}

	@GetMapping("/themeByCode")
	public List<ThemeDTO> themeByCode(@RequestParam("code") String code){
