...
public class CategoryAPI {
	...
	public  CategoryDTO findCategoryByCode(@RequestParam("code") String code) {
		return categoryService.findCategoryByCode(code);
	}

	@GetMapping("/getOneCategoryById")
	public CategoryDTO getOneCategoryById(@RequestParam("id") long id) {
		return categoryService.getOneCategoryById(id);
	}

	@GetMapping("/getCategoryByThemeId")
	public CategoryDTO getCategoryByThemeId(@RequestParam("id") long id){
		return categoryService.getCategoryByThemeId(id);
	}
}
