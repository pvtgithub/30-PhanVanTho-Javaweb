...
public class CategoryService implements ICategoryService {
    ...
    public CategoryDTO findCategoryByCode(String code) {
        ...
        CategoryEntity categoryEntity = new CategoryEntity();
        categoryEntity = categoryRepository.findOneByCode(code);
    ...
    @Override
    public CategoryDTO getCategoryByThemeId(long id) {
        CategoryEntity categoryEntity = categoryRepository.findByThemeId(id);
        return modelMapper.map(categoryEntity, CategoryDTO.class);
    }
